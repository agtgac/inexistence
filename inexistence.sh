#!/bin/bash
#
# https://github.com/agtgac/inexistence
# Author: Aniverse
#
# --------------------------------------------------------------------------------
usage() {
bash <(wget -qO- https://git.io/abcde)
bash <(curl -s https://raw.githubusercontent.com/agtgac/inexistence/master/inexistence.sh)
}
...
wget --no-check-certificate -t1 -T5 -qO- https://raw.githubusercontent.com/agtgac/inexistence/files/logo/inexistence.logo.1
...
if [[ $aptsources == Yes ]] && [[ $CODENAME != jessie ]]; then
    ...
    wget --no-check-certificate -O /etc/apt/sources.list https://github.com/agtgac/inexistence/raw/$default_branch/00.Installation/template/$DISTROL.apt.sources
...
git clone --depth=1 -b $iBranch https://github.com/agtgac/inexistence /etc/inexistence
...
#       cd deluge-$de_version
    ...
    if [[ $Deluge_1_3_15_skip_hash_check_patch == Yes ]]; then
        wget https://raw.githubusercontent.com/agtgac/inexistence/files/miscellaneous/deluge.1.3.15.skip.no.full.allocate.patch \
